        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (!rate33.equals(""))
                {
                    ...
                    else if (sply3.equals("")){
                        Toast.makeText(Option3.this,"Please enter supply notes",Toast.LENGTH_SHORT).show();
                    }
                    else {
                        uri =Uri.parse(uristring);
                        if (uri != null) {
                            final ProgressDialog dialog1 = new ProgressDialog(Option3.this);
                            ...
                            filePath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    newPost.child("size").setValue(size3);
                                    newPost.child("facilities").setValue(facilities3);
                                    newPost.child("rent").setValue(rate33);
                                    newPost.child("sply").setValue(sply3);
                                    newPost.child("desc").setValue(cust_name);
                                    newPost.child("status").setValue("Uploaded");
                                    newPost.child("image").setValue(downloadurl.toString());
                                    Toast.makeText(Option3.this, "Upload Complete", Toast.LENGTH_LONG).show();
                                    if(times.equals("One"))
                                    {
                                        startActivity(new Intent(Option3.this,MainActivity.class));
                                    }
                                    else if (times.equals("Two"))
                                    {
                                        Intent i = new Intent(Option3.this,Option3.class);
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            dialog1.dismiss();
                                            Toast.makeText(Option3.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                                        }
                            ...
                            Toast.makeText(Option3.this,"Please select image",Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
